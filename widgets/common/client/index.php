...
class tx_clients extends Widget_Base
{
    ...
    {
        return __('Client', 'themexriver-addon');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label' => __('Image link', 'themexriver-addon'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tx-client' => 'background: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tx-client' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(    
            ...
            [          
                ...
                'size_units' => ['px', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .tx-client' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tx-client' => 'border:1px solid {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'bdrhclr',
            [
                'label' => esc_html__('Border color hover', 'themexriver-addon'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tx-client:hover' => 'border:1px solid {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tx-client' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
        ...
        $this->add_control(
            'zoom',
            [
                'label' => esc_html__('Zoom image on hover', 'themexriver-addon'),
                'type' => Controls_Manager::SWITCHER,
                'return_value' => 'tx-zoom',
                'default' => 'no',
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute(
            'wrapper',
            [
                'class' => [ 'swiper-container txswiper tx-client-1', $settings['zoom'] ],
            ]
        );
...
$widgets_manager->register(new \Themexriver_Addon\Widgets\tx_clients());
